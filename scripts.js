...
function playRound(playerSelection) {
	...
	const boxPlayerSelection = `You selected ${playerSelection}`;
	const boxComputerSelection = `"He" selected ${computerSelection}`;
	document.querySelector('.box-player').textContent = boxPlayerSelection;
	document.querySelector('.box-computer').textContent = boxComputerSelection;
}
...
selectionRock.addEventListener('click', () => {
	playRound('rock'); document.querySelector('#audio-button').currentTime = 0; document.querySelector('#audio-button').play();
});
selectionPaper.addEventListener('click', () => {
	playRound('paper'); document.querySelector('#audio-button').currentTime = 0; document.querySelector('#audio-button').play();
});
selectionScissors.addEventListener('click', () => {
	playRound('scissors'); document.querySelector('#audio-button').currentTime = 0; document.querySelector('#audio-button').play();
});
